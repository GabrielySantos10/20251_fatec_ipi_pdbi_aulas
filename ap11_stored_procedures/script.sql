...
--   IN p_valor_a_pagar INT, -- IN de INPUT
--   IN p_code_pedido INT
...
--   SELECT LASTVAL()INTO p_cod_pedido; --pega e armazena o serial number de uma tabela
-- END;
-- $$
